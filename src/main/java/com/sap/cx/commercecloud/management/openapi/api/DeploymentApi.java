...
import com.sap.cx.commercecloud.management.openapi.model.CreateDeploymentDecisionRequestDTO;
import com.sap.cx.commercecloud.management.openapi.model.CreateDeploymentDecisionResponseDTO;
...
import com.sap.cx.commercecloud.management.openapi.model.DeploymentCancellationOptionsDetailDTO;
import com.sap.cx.commercecloud.management.openapi.model.DeploymentCancellationRequestDTO;
import com.sap.cx.commercecloud.management.openapi.model.DeploymentDecisionsDTO;
...
import com.sap.cx.commercecloud.management.openapi.model.DeploymentModesPerEnvironmentDTO;
...
import com.sap.cx.commercecloud.management.openapi.model.TrafficSplitDetailDTO;
import com.sap.cx.commercecloud.management.openapi.model.TrafficSplitHistoryListDTO;
import com.sap.cx.commercecloud.management.openapi.model.UpdateTrafficSplitRequestDTO;
...
public interface DeploymentApi {
  ...
  Call<CreateDeploymentResponseDTO> createDeployment(
    @retrofit2.http.Body CreateDeploymentRequestDTO body, @retrofit2.http.Path("subscriptionCode") String subscriptionCode
  );
  ...
  Call<Void> createDeploymentCancellation(
    @retrofit2.http.Body DeploymentCancellationRequestDTO body, @retrofit2.http.Path("subscriptionCode") String subscriptionCode, @retrofit2.http.Path("deploymentCode") String deploymentCode
  );
  ...
  Call<CreateDeploymentDecisionResponseDTO> createDeploymentDecision(
    @retrofit2.http.Body CreateDeploymentDecisionRequestDTO body, @retrofit2.http.Path("subscriptionCode") String subscriptionCode, @retrofit2.http.Path("deploymentCode") String deploymentCode
  );
  ...
  Call<DeploymentDetailDTO> getDeployment(
    @retrofit2.http.Path("subscriptionCode") String subscriptionCode, @retrofit2.http.Path("deploymentCode") String deploymentCode
  );
  ...
  Call<DeploymentCancellationOptionsDetailDTO> getDeploymentCancellationOptions(
    @retrofit2.http.Path("subscriptionCode") String subscriptionCode, @retrofit2.http.Path("deploymentCode") String deploymentCode
  );
  ...
  Call<DeploymentDecisionsDTO> getDeploymentDecisions(
    @retrofit2.http.Path("subscriptionCode") String subscriptionCode, @retrofit2.http.Path("deploymentCode") String deploymentCode
  );
  ...
  Call<List<DeploymentModesPerEnvironmentDTO>> getDeploymentModes(
  ...
  Call<DeploymentProgressDTO> getDeploymentProgress(
    @retrofit2.http.Path("subscriptionCode") String subscriptionCode, @retrofit2.http.Path("deploymentCode") String deploymentCode
  );
  ...
  Call<DeploymentDetailsDTO> getDeployments(
  ...
  Call<TrafficSplitDetailDTO> getTrafficSplit(
    @retrofit2.http.Path("subscriptionCode") String subscriptionCode, @retrofit2.http.Path("deploymentCode") String deploymentCode
  );
  ...
  Call<TrafficSplitHistoryListDTO> getTrafficSplitHistory(
    @retrofit2.http.Path("subscriptionCode") String subscriptionCode, @retrofit2.http.Path("deploymentCode") String deploymentCode, @retrofit2.http.Query("$top") Integer $top, @retrofit2.http.Query("$skip") Integer $skip, @retrofit2.http.Query("$orderby") String $orderby, @retrofit2.http.Query("$count") Boolean $count
  );
  ...
  Call<TrafficSplitDetailDTO> updateTrafficSplit(
    @retrofit2.http.Body UpdateTrafficSplitRequestDTO body, @retrofit2.http.Path("subscriptionCode") String subscriptionCode, @retrofit2.http.Path("deploymentCode") String deploymentCode
  );
