package com.sap.cx.commercecloud.management.openapi;
...
import com.sap.cx.commercecloud.management.openapi.auth.HttpBasicAuth;
import com.sap.cx.commercecloud.management.openapi.auth.ApiKeyAuth;
import com.sap.cx.commercecloud.management.openapi.auth.OAuth;
import com.sap.cx.commercecloud.management.openapi.auth.OAuth.AccessTokenListener;
import com.sap.cx.commercecloud.management.openapi.auth.OAuthFlow;
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("OAuth2".equals(authName)) {
        auth = new OAuth(OAuthFlow.application, "", "https://ycloud.accounts.ondemand.com/oauth2/token", "");
      } else {
...
class GsonResponseBodyConverterToString<T> implements Converter<ResponseBody, T> {
  ...
  @Override public T convert(ResponseBody value) throws IOException {
    ...
    try {
      ...
      if (returned.contains("oauth2/authorize") || returned.contains("accounts.ondemand.com")) {
        throw new IOException("API token has expired. Please update it in Settings.");
      }
      throw new IOException("Failed to parse API response: " + returned, e);
    }
  }
}
