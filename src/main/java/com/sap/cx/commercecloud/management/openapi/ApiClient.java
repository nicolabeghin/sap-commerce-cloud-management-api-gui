    ...
    public ApiClient(String[] authNames) {
        ...
        for (String authName : authNames) {
            ...
            if ("OAuth2".equals(authName)) {
                auth = new OAuth(OAuthFlow.accessCode, "https://oauthasservices-a9f746d57.hana.ondemand.com/oauth2/api/v1/authorize", "https://oauthasservices-a9f746d57.hana.ondemand.com/oauth2/api/v1/token", "");
            } else {
